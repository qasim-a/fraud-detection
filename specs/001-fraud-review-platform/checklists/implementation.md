...
- [x] SC-001 local scoring latency evidence records 100/100 requests under two seconds.
- [x] SC-007 records a one-million-row benchmark with elapsed time, environment, size, and lineage.

## Final gate

- [x] Every quickstart command has been executed and recorded in `docs/verification.md`.
- [x] Full Docker-backed health, migration, scoring, and shutdown workflow passes.
